...
//                        dialog.cancel();
    ...
    private void getLocation() {
        if (ActivityCompat.checkSelfPermission(
                NewDashbord.this,Manifest.permission.ACCESS_FINE_LOCATION) != PackageManager.PERMISSION_GRANTED && ActivityCompat.checkSelfPermission(
                NewDashbord.this, Manifest.permission.ACCESS_COARSE_LOCATION) != PackageManager.PERMISSION_GRANTED) {
