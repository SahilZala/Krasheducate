...
private Context ctx;
private AdapterTopicList.OnItemClickListener mOnItemClickListener;
private AdapterTopicList.OnItemClickListener mOnItemClickListener1;
...
public interface OnItemClickListener {
    ...
    public void setOnItemClickListener(final AdapterTopicList.OnItemClickListener mItemClickListener) {
        this.mOnItemClickListener = mItemClickListener;
    }

    public void setOnItemClickListener1(final AdapterTopicList.OnItemClickListener mItemClickListener) {
...
public class OriginalViewHolder extends RecyclerView.ViewHolder {
    ...
    public RecyclerView.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        ...
        vh = new AdapterTopicList.OriginalViewHolder(v);
        return vh;
    }
    ...
    public void onBindViewHolder(RecyclerView.ViewHolder holder, final int position) {
        if (holder instanceof AdapterTopicList.OriginalViewHolder) {
            AdapterTopicList.OriginalViewHolder view = (AdapterTopicList.OriginalViewHolder) holder;
