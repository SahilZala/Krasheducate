    ...
    protected void onCreate(Bundle savedInstanceState) {
      ...
      // setContentView(R.layout.activity_intro_screen);
        ...
        if(v.equals("1"))
        {
            ...
            addSlide(AppIntroFragment.newInstance("Welcome To 'Learn Digital Marketing and Promotions' App ","bottom","A Product By Graphics Era  for DIGITAL STUDENTS(THINK DIGITAL)","", R.drawable.onlinelearning,ContextCompat.getColor(getApplicationContext(), R.color.mate_red),ContextCompat.getColor(getApplicationContext(), R.color.white),ContextCompat.getColor(getApplicationContext(), R.color.white)));
